const cuteAlert = ({
    ...
    return new Promise(resolve => {
      ...
      for (let script of scripts) {
        if (script.src.includes('waping.js')) {
      ...
      <div class="alert-wrapper">
        <div class="alert-frame">
          ${img !== '' ? '<div class="alert-header ' + type + '-bg">' : '<div>'}
            ...
            ${img !== '' ? '<img class="alert-img" src="https://cdn.discordapp.com/attachments/783489649985060904/939339873503023154/Roy_Vending-removebg-preview.png" />' : ''}
          </div>
